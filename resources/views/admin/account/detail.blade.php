...
,You will be redirected to Login page"   ></i>
            ...
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <div class="">
                    ...
                    <input type="text" name="name" class="form-control @if ($errors->has('name')) is-invalid @elseif($errors->has('email')||$errors->has('phone')||$errors->has('address')) is-valid  @endif" id="" placeholder="name..." value="{{ old('name',auth()->user()->name) }}" autofocus>
                </div>
                @error('name')
                ...
                <div class="">
                    ...
                    <input type="email" name="email" class="form-control @if ($errors->has('email')) is-invalid @elseif($errors->has('name')||$errors->has('phone')||$errors->has('address')) is-valid  @endif" id="" placeholder="example@..." value="{{ old('email',auth()->user()->email) }}">
                </div>
                @error('email')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
                ...
                <div class="">
                    ...
                    <input type="text" name="phone" class="form-control @if ($errors->has('phone')) is-invalid @elseif($errors->has('name')||$errors->has('email')||$errors->has('address')) is-valid  @endif" id="" placeholder="09..." value="{{ old('phone',auth()->user()->phone) }}">
                </div>
                @error('phone')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
                ...
                <div class="">
                    ...
                    <input type="text" name="address" class="form-control @if ($errors->has('address')) is-invalid @elseif($errors->has('name')||$errors->has('email')||$errors->has('phone')) is-valid  @endif" id="" placeholder="Yan..." value="{{ old('address',auth()->user()->address) }}">
                </div>
                @error('address')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
  ...
  <div class="modal fade" id="uploadImage" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="{{ route('admin#userImageUpdate') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
              ...
              <div class="modal-body">
                <div class="col-6 offset-3">
                    ...
                    <input type="file" class="form-control mt-3 ms-3 @error('image') is-invalid @enderror" name="image" id="" >
                    @error('image')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
